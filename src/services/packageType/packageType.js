export async function postPackageTypeCreate(
    title,
     token,
      chabk,
      setMessageData,
    ) {
    const url = `https://${chabk}/Product/PackageType/Create`;
...
export async function postPackageTypeGetList(
    dataAll,
    token,
    chabk,
    setDataTable,
    ...
    const url = `https://${chabk}/Product/PackageType/GetList`;
...
export async function postPackageTypeUpdatePackage(
    edit,
     token,
     chabk,
     setCheckDataAll,
    ...
    const url = `https://${chabk}/Product/PackageType/Update`;
...
export async function postPackageTypeDelete(edit, token, chabk , setMessageData) {
    const url = `https://${chabk}/Product/PackageType/Delete`;
