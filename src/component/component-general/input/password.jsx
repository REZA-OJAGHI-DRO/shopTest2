  ...
  return (
    <>
      <div className={`${width} flex flex-wrap gap-1 md:gap-3`}>
        <label htmlFor="" className="w-full text-white text-[1.2rem] lg:text-[1.5rem]">
          {label}
        </label>
        <div className={` w-full rounded-xl px-2 gap-3 py-1 shadow-inner-custom-2 bg-[rgb(217,217,217)] flex justify-between items-center`}>
          <input
            ...
            className="bg-transparent w-full h-[40px] lg:h-[50px] text-right text-[1rem] lg:text-[1.2rem] px-4 focus:border-transparent focus:outline-none"
          />
            <svg
