...
const InputNumber = forwardRef(
  (
    ...
    return (
      <div className={`${width} flex flex-wrap gap-1 lg:gap-2`}>
        <label htmlFor="" className={`${styleLabel} w-full`}>
          {label}
        </label>
        <div
          className={` w-full rounded-2xl ${styleBox} bg-[rgba(228, 228, 228, 1)] px-2 gap-3 py-1 shadow-inner-custom-2 flex justify-between items-center`}
        >
          <input
            {...rest}
            ref={ref} 
