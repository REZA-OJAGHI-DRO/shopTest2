import UploadVideoImgSupplier from "./upload-video-iamge-supplier";
import {
  React,
  useCallback,
  useEffect,
...
function GallerySupplier() {
  ...
  }, [id, token, chabk, updateImage, updateDelete, update]);
  useEffect(() => {
    GetFiles();
  }, [GetFiles, updateImage, updateDelete, update]);
useEffect(()=>{
                    ...
                    <div className="w-full">
                      <div className="w-full flex" dir="ltr">
                        <section dir="rtl" className="w-full h-full">
                          <UploadVideoImgSupplier
                            id={id}
                            play={play}
                            setPlay={setPlay}
                            updateImage={updateTable}
