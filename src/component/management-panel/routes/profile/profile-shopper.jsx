...
const ViewShopper = React.lazy(() => import("./view-shopper-profile.jsx"));
const EditShopper = React.lazy(() => import("./edit-shopper-profile/edit-shopper-profile.jsx"));
import {
  React,
  Suspense,
  useCallback,
...
function profileShopper() {
  const [updateTable, setUpdateTable] = useState(false);
  const token = useSelector((state) => state.product.token);
  const chabk = useSelector((state) => state.product.chabk);
  const [id, setId] = useState("");
  // const [id, setId] = useState("/6NEvvQKeM7scGMkIa0QRA==");
                ...
                <div className="w-[100%] flex justify-center flex-wrap">
                  <div className=" w-full h-[140px]">
                    ...
                    <div className="w-full flex flex-wrap">
                      ...
                      <div className="w-[100%] h-[70px] flex justify-center items-center gap-4 z-50">
