import WithSupport from "../../componentGeneral/withSupport";
import img from "/img/icon-2.png";

function FinalRegistration({ stage7 }) {
  return (
    <section
      style={{ display: stage7 == false ? "flex" : "none" }}
      className="w-full h-full flex-wrap justify-center items-center"
    >
      <article className="w-[85%] lg:w-[40%] h-[90%] flex flex-wrap justify-center items-center">
